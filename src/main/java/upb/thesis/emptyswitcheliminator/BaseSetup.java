...
//import sootup.java.bytecode.interceptors.EmptySwitchEliminator;
...
//        ClassType classType =
//                view.getIdentifierFactory().getClassType("upb.thesis.emptyswitcheliminator.SampleClass");
...
//                .getMethodSignature("testEmptySwitchEliminator", "upb.thesis.emptyswitcheliminator.SampleClass", "String", Collections.emptyList());
