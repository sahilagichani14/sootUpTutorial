...
public class BaseSetup {
    public void setUp() {
        ...
        ClassType classType =
                view.getIdentifierFactory().getClassType("upb.thesis.RQ1.SampleClass");
        System.out.println(classType);
        JavaSootClass sootClass = view.getClass(classType).get();
        System.out.println(sootClass);

        MethodSignature methodSignature = view.getIdentifierFactory()
                .getMethodSignature("upb.thesis.RQ1.SampleClass", "conditionalBranchFolderTest2", "void", Collections.emptyList());
