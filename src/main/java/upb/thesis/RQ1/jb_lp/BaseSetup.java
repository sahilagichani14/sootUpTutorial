...
//                List.of(new ConditionalBranchFolder()));
        ...
        ClassType classType =
                view.getIdentifierFactory().getClassType("upb.thesis.RQ1.jb_lp.SampleClass");
        System.out.println(classType);
        JavaSootClass sootClass = view.getClass(classType).get();
        System.out.println(sootClass);

        MethodSignature methodSignature = view.getIdentifierFactory()
                .getMethodSignature("upb.thesis.RQ1.jb_lp.SampleClass", "localSplitterTest", "void", Collections.emptyList());
